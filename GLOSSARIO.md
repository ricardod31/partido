...
| **Buro** | Direção de um organismo, com papéis especializados (secretário, tesoureiro, agitprop). | [doc 01](docs/01-fundamentos-leninistas.md) |
...
| **Organismo** | Qualquer instância organizada da estrutura: célula, comitê, comissão, fração, congresso, buro/direção. Os organismos formam uma árvore cuja raiz é a organização. | [doc 02](docs/02-modelo-de-dominio.md) |
