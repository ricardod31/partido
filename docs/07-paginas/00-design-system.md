...
| `mural.metadados` | P-ORG-02 (TrustChip → folha) | Protegido · o servidor vê: **para qual grupo, quando, tamanho** — não o conteúdo, não qual membro escreveu (vê "um dos N"). | (o chip já é o resumo) | "o servidor não vê nada" |
